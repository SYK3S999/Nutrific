...
const Card = React.forwardRef<HTMLDivElement, CardProps>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-lg border bg-card text-card-foreground shadow-sm transform transition-transform duration-500 ease-in-out hover:scale-105 fade-in", // added hover and fade-in animations
      className
    )}
    {...props}
  />
